...
const Stories = () => {
  return (
    <>
      <div className="w-full h-full p-16 flex place-content-center justify-center items-center bg-[white] flex-col mb-[30px]">
        <div className="w-[80%] h-auto p-8 pb-16 flex place-content-center flex-col gap-[10px] text-center text-[#02102A]">
          <h2 className="text-[32px] font-semibold lg:text-[60px] md:text-[34px] text-start">
            Traveling In Style
          </h2>
        </div>
        <div className="items-center justify-center flex-row flex h-[100vh] gap-[20px] p-4 bg-[] w-[80%]">
          <div className="w-[50%] h-[100%] flex flex-col">
            ...
            <div className="h-auto w-full flex flex-col gap-[15px] p-8 text-[#02102A]">
              <p className="text-[32px] font-semibold lg:text-[15px] md:text-[13px] uppercase">
                ICONIC DESTINATION
              </p>
              ...
              <span className="text-[18px] underline font-bold cursor-pointer">
                Explore Engelberg
              </span>
            </div>
          </div>
          <div className="w-[60%] h-full  relative">
            ...
            <div className="w-[90%] h-[60%] absolute bottom-0 right-0 bg-[#F8F6F0] z-10">
